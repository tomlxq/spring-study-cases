 ...
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://tom.com/", wsdlLocation = "http://localhost:8888/sayHello?wsdl")
public class SayHelloImplService
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://tom.com/", "SayHelloImplService");
    ...
    /**
     * @return returns SayHelloImpl
     */
    @WebEndpoint(name = "SayHelloImplPort")
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://tom.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tom.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
